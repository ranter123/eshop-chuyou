...
public class PayOrderMembershipUpdater extends AbstractMembershipUpdater<Object, Boolean>{
     ...
     */
    @Override
    protected Map<String, Object> undoUpdateMemberLevel(Long userAccountId,
                                                         Object parameter) throws Exception {
        Double totalOrderAmount = (Double) parameter;
     ...
     */
    @Override
    protected Map<String, Object> undoUpdateMemberPoint(Long userAccountId,
                                                         Object parameter) throws Exception {
        Double totalOrderAmount = (Double) parameter;
