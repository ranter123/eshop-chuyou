...
public class PayOrderStockUpdaterFactory<T> extends AbstractStockUpdaterFactory<T> {
    ...
    @Autowired
    public PayOrderStockUpdaterFactory(GoodsStockDAO goodsStockDAO) {
        super(goodsStockDAO);
    }
    ...
    protected StockUpdater create(List<GoodsStockDO> goodsStockDOs, T parameter) throws Exception {
        ...
        return new PayOrderStockUpdater(goodsStockDOs, goodsStockDAO, orderItemDTOMap);
    }
}
